...
export const get_tag_category = () => async (dispatch) => {
  try {
    const response = await axios.get(
      'http://localhost:5000/rest-api/get-tag-category',
...
export const add_article = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      'http://localhost:5000/rest-api/add-article',
      data,
      { withCredentials: true }
    );
    dispatch({
...
export const get_all_article =
  (currentPage, searchValue) => async (dispatch) => {
    try {
      const response = await axios.get(
        `http://localhost:5000/rest-api/get-article?currentPage=${currentPage}&&searchValue=${searchValue}`,
        { withCredentials: true }
      );
      dispatch({
...
export const article_edit = (articleSlug) => async (dispatch) => {
  try {
    const response = await axios.get(
      `http://localhost:5000/rest-api/edit-article/${articleSlug}`,
      { withCredentials: true }
    );
...
export const article_update = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      'http://localhost:5000/rest-api/update-article',
      data,
      { withCredentials: true }
    );
    dispatch({
...
export const delete_article = (articleId) => async (dispatch) => {
  try {
    const response = await axios.delete(
      `http://localhost:5000/rest-api/delete-article/${articleId}`,
      { withCredentials: true }
    );
    dispatch({
